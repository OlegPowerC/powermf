...
Добавим корневой сертификат нашего удостоверяющего центра в доверенные на Linux OS (пример для Red Hat и подобных дистрибутивов):
...
Пользователь Usertest подключается не заполняя сразу поле второго пароля, он получает одноразовый пароль или по почте, или по SMS
